 ...
 * 
 */
class NavitAvailableSpaceHandler
{
	//********
	// Variables
	/**
	 ...
	 */
	static long getExternalAvailableSpaceInBytes(String directory)
	{
	...
	private static float getExternalAvailableSpaceInMBformatted(String directory)
	{
	...
	private static float getExternalAvailableSpaceInGBformatted(String directory)
	{
	...
	private static String SpaceCustomNumberFormat(String pattern, double value)
	{
	 ...
	 */
	//static long getExternalStorageAvailableBlocks(String directory)
	//{
